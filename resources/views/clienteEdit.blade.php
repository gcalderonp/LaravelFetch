...
<div class="container mt-5">
    ...
    <form id="clienteForm" class="border border-2 rounded p-3" action="clienteUpdate" method="POST">
        ...
        <div class="form-group">
            ...
            <input autocomplete="off" name="age" class="form-control" placeholder="Ingrese Edad" type="number" value="{{ $cliente->edad }}">
        </div>
